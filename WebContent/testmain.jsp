...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous"><base>
...
<div class="animate__animated animate__fadeIn" style="height:65px;border-left:4px solid #e8974c;padding-left:25px; margin-bottom: 35px;margin-top:20px;">
   <a href="book?param=booklist"><h2>내 서재</h2></a>
   <p style="font-style: italic;">wishlist와 readlist를 볼 수 있습니다.</p>
	...
	<div class="row">
				 ...
				 for(int i=0; i<wishlist.size(); i++){
					 ...
					 System.out.println("wishlistsize = " + readlist.size());
					  ...
					  <a href="book?param=bookdetail&booknum=<%=wishdto.getBooknum() %>">
					   <img class="service" src="<%=wishdto.getBookimage() %>" height="120" width="90">
					  </a>
					  </td>
				 ...
				 for(int i=0; i<readlist.size(); i++){
					 ...
					 System.out.println("readlistSIZE = " + wishlist.size());
					  ...
					  <td  class="booktd">
					   ...
					   <img class="service" src="<%=readdto.getBookimage() %>" height="120" width="90">
					    </a>
					  </td>
		...
		<div class=" col-sm-4 memAndclub">
			...
			<div class=" member" style="width: 300px;margin-bottom: 5px;" >
				<!-- <h2>PROFILE</h2> -->
									...
									<div class="card">
										<div class="card-header">
												...
												<div class="profile_pic">
													<img alt="" src="<%=memberdto.getUserimage() %>" onerror='this.src="./img/user_80px.jpg"' >
												</div>
										...
										<div class="card-footer">
											<div class="view_profile">
												<a href="schedule?param=calendarlist&membernum=<%=membernum %>" style="color: #f6f6f6; text-decoration: none;">일정관리</a> <!-- param 값 안근이가 하는거 -->
											</div>
											<div class="message">
		...
		<!-- -----------------커뮤니티--------------->		
			...
			<div class="clublist">
					<table class="clublisttable" style="" id="ta">
					<col width="350px">
					<tr>
					<th style="font-size: 20pt;text-align:center; background-color: #e8d3c1;height: 80px;color:#666663">MY CLUB</th>
					</tr>
						...
						if(clublist == null || clublist.size() == 0){ // 저장된 게시물으 없을 경우
						  ...
						  <% 
							    ...
							    <tr class="something">		
									...
									%>									
									<td style="" onmouseover="this.style.background='#f1edea'" onmouseout="this.style.background='white'">
